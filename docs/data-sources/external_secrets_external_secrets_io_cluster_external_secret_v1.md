...
page_title: "kubefu_external_secrets_external_secrets_io_cluster_external_secret_v1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  ClusterExternalSecret is the Schema for the clusterexternalsecrets API.
---

# kubefu_external_secrets_external_secrets_io_cluster_external_secret_v1 (Data Source)
...
Evaluated in UTC, only for Periodic refresh policy (or when refreshPolicy is unset). (see [below for nested schema](#nestedblock--spec--external_secret_spec--sync_windows))
...
<a id="nestedblock--spec--external_secret_spec--sync_windows"></a>
### Nested Schema for `spec.external_secret_spec.sync_windows`
...
- `windows` (Block List) Windows is the list of schedule+duration pairs. (see [below for nested schema](#nestedblock--spec--external_secret_spec--sync_windows--windows))

<a id="nestedblock--spec--external_secret_spec--sync_windows--windows"></a>
### Nested Schema for `spec.external_secret_spec.sync_windows.windows`
