...
page_title: "kubefu_k8s_autoscaling_horizontal_pod_autoscaler_v2 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  HorizontalPodAutoscaler is the configuration for a horizontal pod autoscaler, which automatically manages the replica count of any resource implementing the scale subresource based on the metrics specified.
---

# kubefu_k8s_autoscaling_horizontal_pod_autoscaler_v2 (Data Source)
...
- `spec` (Block List, Max: 1) spec is the specification for the behaviour of the autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status. (see [below for nested schema](#nestedblock--spec))
...
- `container_resource` (Block List, Max: 1) containerResource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod of the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source. This is an alpha feature and can be enabled by the HPAContainerMetrics feature flag. (see [below for nested schema](#nestedblock--spec--metrics--container_resource))
...
- `target` (Block List, Min: 1, Max: 1) target specifies the target value for the given metric (see [below for nested schema](#nestedblock--spec--metrics--container_resource--target))
...
- `metric` (Block List, Min: 1, Max: 1) metric identifies the target metric by name and selector (see [below for nested schema](#nestedblock--spec--metrics--external--metric))
- `target` (Block List, Min: 1, Max: 1) target specifies the target value for the given metric (see [below for nested schema](#nestedblock--spec--metrics--external--target))

<a id="nestedblock--spec--metrics--external--metric"></a>
...
<a id="nestedblock--spec--metrics--external--metric--selector"></a>
### Nested Schema for `spec.metrics.external.metric.selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--metrics--external--metric--selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--metrics--external--metric--selector--match_expressions"></a>
...
<a id="nestedblock--spec--metrics--external--target"></a>
...
- `described_object` (Block List, Min: 1, Max: 1) describedObject specifies the descriptions of a object,such as kind,name apiVersion (see [below for nested schema](#nestedblock--spec--metrics--object--described_object))
- `metric` (Block List, Min: 1, Max: 1) metric identifies the target metric by name and selector (see [below for nested schema](#nestedblock--spec--metrics--object--metric))
- `target` (Block List, Min: 1, Max: 1) target specifies the target value for the given metric (see [below for nested schema](#nestedblock--spec--metrics--object--target))

<a id="nestedblock--spec--metrics--object--described_object"></a>
...
<a id="nestedblock--spec--metrics--object--metric"></a>
...
<a id="nestedblock--spec--metrics--object--metric--selector"></a>
### Nested Schema for `spec.metrics.object.metric.selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--metrics--object--metric--selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--metrics--object--metric--selector--match_expressions"></a>
...
- `metric` (Block List, Min: 1, Max: 1) metric identifies the target metric by name and selector (see [below for nested schema](#nestedblock--spec--metrics--pods--metric))
- `target` (Block List, Min: 1, Max: 1) target specifies the target value for the given metric (see [below for nested schema](#nestedblock--spec--metrics--pods--target))

<a id="nestedblock--spec--metrics--pods--metric"></a>
...
<a id="nestedblock--spec--metrics--pods--metric--selector"></a>
### Nested Schema for `spec.metrics.pods.metric.selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--metrics--pods--metric--selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--metrics--pods--metric--selector--match_expressions"></a>
...
<a id="nestedblock--spec--metrics--pods--target"></a>
...
- `name` (String) name is the name of the resource in question.
- `target` (Block List, Min: 1, Max: 1) target specifies the target value for the given metric (see [below for nested schema](#nestedblock--spec--metrics--resource--target))

<a id="nestedblock--spec--metrics--resource--target"></a>
...
- `container` (String) Container is the name of the container in the pods of the scaling target
- `current` (Block List, Min: 1, Max: 1) current contains the current value for the given metric (see [below for nested schema](#nestedblock--status--current_metrics--container_resource--current))
- `name` (String) Name is the name of the resource in question.
...
- `current` (Block List, Min: 1, Max: 1) current contains the current value for the given metric (see [below for nested schema](#nestedblock--status--current_metrics--external--current))
- `metric` (Block List, Min: 1, Max: 1) metric identifies the target metric by name and selector (see [below for nested schema](#nestedblock--status--current_metrics--external--metric))

<a id="nestedblock--status--current_metrics--external--current"></a>
### Nested Schema for `status.current_metrics.external.current`
...
<a id="nestedblock--status--current_metrics--external--metric"></a>
### Nested Schema for `status.current_metrics.external.metric`
...
- `selector` (Block List, Max: 1) selector is the string-encoded form of a standard kubernetes label selector for the given metric When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping. When unset, just the metricName will be used to gather metrics. (see [below for nested schema](#nestedblock--status--current_metrics--external--metric--selector))

<a id="nestedblock--status--current_metrics--external--metric--selector"></a>
### Nested Schema for `status.current_metrics.external.metric.selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--status--current_metrics--external--metric--selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--status--current_metrics--external--metric--selector--match_expressions"></a>
### Nested Schema for `status.current_metrics.external.metric.selector.match_expressions`
...
- `current` (Block List, Min: 1, Max: 1) current contains the current value for the given metric (see [below for nested schema](#nestedblock--status--current_metrics--object--current))
- `described_object` (Block List, Min: 1, Max: 1) DescribedObject specifies the descriptions of a object,such as kind,name apiVersion (see [below for nested schema](#nestedblock--status--current_metrics--object--described_object))
- `metric` (Block List, Min: 1, Max: 1) metric identifies the target metric by name and selector (see [below for nested schema](#nestedblock--status--current_metrics--object--metric))

<a id="nestedblock--status--current_metrics--object--current"></a>
### Nested Schema for `status.current_metrics.object.current`
...
<a id="nestedblock--status--current_metrics--object--described_object"></a>
### Nested Schema for `status.current_metrics.object.described_object`
...
<a id="nestedblock--status--current_metrics--object--metric"></a>
### Nested Schema for `status.current_metrics.object.metric`
...
- `selector` (Block List, Max: 1) selector is the string-encoded form of a standard kubernetes label selector for the given metric When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping. When unset, just the metricName will be used to gather metrics. (see [below for nested schema](#nestedblock--status--current_metrics--object--metric--selector))

<a id="nestedblock--status--current_metrics--object--metric--selector"></a>
### Nested Schema for `status.current_metrics.object.metric.selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--status--current_metrics--object--metric--selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--status--current_metrics--object--metric--selector--match_expressions"></a>
### Nested Schema for `status.current_metrics.object.metric.selector.match_expressions`
...
- `current` (Block List, Min: 1, Max: 1) current contains the current value for the given metric (see [below for nested schema](#nestedblock--status--current_metrics--pods--current))
- `metric` (Block List, Min: 1, Max: 1) metric identifies the target metric by name and selector (see [below for nested schema](#nestedblock--status--current_metrics--pods--metric))

<a id="nestedblock--status--current_metrics--pods--current"></a>
### Nested Schema for `status.current_metrics.pods.current`
...
<a id="nestedblock--status--current_metrics--pods--metric"></a>
### Nested Schema for `status.current_metrics.pods.metric`
...
- `selector` (Block List, Max: 1) selector is the string-encoded form of a standard kubernetes label selector for the given metric When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping. When unset, just the metricName will be used to gather metrics. (see [below for nested schema](#nestedblock--status--current_metrics--pods--metric--selector))

<a id="nestedblock--status--current_metrics--pods--metric--selector"></a>
### Nested Schema for `status.current_metrics.pods.metric.selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--status--current_metrics--pods--metric--selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--status--current_metrics--pods--metric--selector--match_expressions"></a>
### Nested Schema for `status.current_metrics.pods.metric.selector.match_expressions`
...
- `current` (Block List, Min: 1, Max: 1) current contains the current value for the given metric (see [below for nested schema](#nestedblock--status--current_metrics--resource--current))
- `name` (String) Name is the name of the resource in question.

<a id="nestedblock--status--current_metrics--resource--current"></a>
### Nested Schema for `status.current_metrics.resource.current`
