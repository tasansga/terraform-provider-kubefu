...
page_title: "kubefu_cert_manager_acme_cert_manager_io_order_v1beta1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Order is a type to represent an Order with an ACME server
---

# kubefu_cert_manager_acme_cert_manager_io_order_v1beta1 (Data Source)
