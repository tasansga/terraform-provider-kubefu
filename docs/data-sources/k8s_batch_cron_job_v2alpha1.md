...
page_title: "kubefu_k8s_batch_cron_job_v2alpha1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  CronJob represents the configuration of a single cron job.
---

# kubefu_k8s_batch_cron_job_v2alpha1 (Data Source)
...
- `failed_jobs_history_limit` (Number) The number of failed finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified.
...
- `successful_jobs_history_limit` (Number) The number of successful finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified.
