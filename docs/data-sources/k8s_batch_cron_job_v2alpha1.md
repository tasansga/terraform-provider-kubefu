...
- `match_expressions` (Block List, Min: 1) Required. A list of node selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--job_template--spec--template--spec--affinity--node_affinity--preferred_during_scheduling_ignored_during_execution--preference--match_expressions))
...
- `match_expressions` (Block List, Min: 1) Required. A list of node selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--job_template--spec--template--spec--affinity--node_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions))
...
- `sources` (Block List, Min: 1) list of volume projections (see [below for nested schema](#nestedblock--spec--job_template--spec--template--spec--volumes--projected--sources))
