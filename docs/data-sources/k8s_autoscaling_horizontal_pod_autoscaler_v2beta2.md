...
page_title: "kubefu_k8s_autoscaling_horizontal_pod_autoscaler_v2beta2 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  HorizontalPodAutoscaler is the configuration for a horizontal pod autoscaler, which automatically manages the replica count of any resource implementing the scale subresource based on the metrics specified.
---

# kubefu_k8s_autoscaling_horizontal_pod_autoscaler_v2beta2 (Data Source)
...
- `described_object` (Block List, Min: 1, Max: 1) (see [below for nested schema](#nestedblock--spec--metrics--object--described_object))
...
- `described_object` (Block List, Min: 1, Max: 1) (see [below for nested schema](#nestedblock--status--current_metrics--object--described_object))
