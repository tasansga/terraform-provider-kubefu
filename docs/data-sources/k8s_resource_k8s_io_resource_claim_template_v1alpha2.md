...
The object must be in the same namespace as the ResourceClaim. (see [below for nested schema](#nestedblock--spec--spec--parameters_ref))

<a id="nestedblock--spec--spec--parameters_ref"></a>
