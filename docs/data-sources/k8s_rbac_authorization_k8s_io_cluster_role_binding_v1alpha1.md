...
page_title: "kubefu_k8s_rbac_authorization_k8s_io_cluster_role_binding_v1alpha1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  ClusterRoleBinding references a ClusterRole, but not contain it.  It can reference a ClusterRole in the global namespace, and adds who information via Subject.
---

# kubefu_k8s_rbac_authorization_k8s_io_cluster_role_binding_v1alpha1 (Data Source)
...
- `role_ref` (Block List, Min: 1, Max: 1) RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error. (see [below for nested schema](#nestedblock--role_ref))
