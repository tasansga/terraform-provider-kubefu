...
page_title: "kubefu_k8s_scheduling_k8s_io_priority_class_v1alpha1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  PriorityClass defines mapping from a priority class name to the priority integer value. The value can be any valid integer.
---

# kubefu_k8s_scheduling_k8s_io_priority_class_v1alpha1 (Data Source)
...
- `global_default` (Boolean) globalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do not have any priority class.
- `metadata` (Block List, Max: 1) Standard object's metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata (see [below for nested schema](#nestedblock--metadata))
