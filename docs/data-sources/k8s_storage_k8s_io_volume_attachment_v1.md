...
<a id="nestedblock--spec--source--inline_volume_spec--csi--node_expand_secret_ref"></a>
...
- `error_code` (Number) errorCode is a numeric gRPC code representing the error encountered during Attach or Detach operations.
