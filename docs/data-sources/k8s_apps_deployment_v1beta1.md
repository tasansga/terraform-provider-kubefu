...
page_title: "kubefu_k8s_apps_deployment_v1beta1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Deployment enables declarative updates for Pods and ReplicaSets.
---

# kubefu_k8s_apps_deployment_v1beta1 (Data Source)
...
- `revision_history_limit` (Number) The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. Defaults to 2.
- `rollback_to` (Block List, Max: 1) The config this deployment is rolling back to. Will be cleared after rollback is done. (see [below for nested schema](#nestedblock--spec--rollback_to))
- `selector` (Block List, Max: 1) Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment. (see [below for nested schema](#nestedblock--spec--selector))
...
<a id="nestedblock--spec--rollback_to"></a>
### Nested Schema for `spec.rollback_to`
...
- `unavailable_replicas` (Number) Total number of unavailable pods targeted by this deployment.
