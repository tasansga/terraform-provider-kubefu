...
- `rollback_to` (Block List, Max: 1) DEPRECATED. The config this deployment is rolling back to. Will be cleared after rollback is done. (see [below for nested schema](#nestedblock--spec--rollback_to))
