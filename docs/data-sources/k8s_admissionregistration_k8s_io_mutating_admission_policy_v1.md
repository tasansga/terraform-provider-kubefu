...
page_title: "kubefu_k8s_admissionregistration_k8s_io_mutating_admission_policy_v1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  MutatingAdmissionPolicy describes the definition of an admission mutation policy that mutates the object coming into admission chain.
---

# kubefu_k8s_admissionregistration_k8s_io_mutating_admission_policy_v1 (Data Source)
...
- `spec` (Block List, Max: 1) spec defines the desired behavior of the MutatingAdmissionPolicy. (see [below for nested schema](#nestedblock--spec))
