...
page_title: "kubefu_k8s_resource_k8s_io_resource_slice_v1alpha3 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
...
# kubefu_k8s_resource_k8s_io_resource_slice_v1alpha3 (Data Source)
...
- `basic` (Block List, Max: 1) Basic defines one device instance. (see [below for nested schema](#nestedblock--spec--devices--basic))

<a id="nestedblock--spec--devices--basic"></a>
### Nested Schema for `spec.devices.basic`
...
- `counter_set` (String) CounterSet defines the set from which the counters defined will be consumed.
- `counters` (Map of String) Counters defines the Counter that will be consumed by the device.
...
- `counters` (Map of String) Counters defines the counters that will be consumed by the device. The name of each counter must be unique in that set and must be a DNS label.
