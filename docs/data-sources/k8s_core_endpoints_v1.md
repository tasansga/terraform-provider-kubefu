...
- `target_ref` (Block List, Max: 1) Reference to object providing the endpoint. (see [below for nested schema](#nestedblock--subsets--addresses--target_ref))

<a id="nestedblock--subsets--addresses--target_ref"></a>
...
- `hostname` (String) The Hostname of this endpoint
- `node_name` (String) Optional: Node hosting this endpoint. This can be used to determine endpoints local to a node.
- `target_ref` (Block List, Max: 1) Reference to object providing the endpoint. (see [below for nested schema](#nestedblock--subsets--not_ready_addresses--target_ref))

<a id="nestedblock--subsets--not_ready_addresses--target_ref"></a>
