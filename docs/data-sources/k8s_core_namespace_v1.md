...
page_title: "kubefu_k8s_core_namespace_v1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Namespace provides a scope for Names. Use of multiple namespaces is optional.
---

# kubefu_k8s_core_namespace_v1 (Data Source)
...
- `spec` (Block List, Max: 1) Spec defines the behavior of the Namespace. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status (see [below for nested schema](#nestedblock--spec))
- `status` (Block List, Max: 1) Status describes the current status of a Namespace. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status (see [below for nested schema](#nestedblock--status))
...
- `finalizers` (List of String) Finalizers is an opaque list of values that must be empty to permanently remove object from storage. More info: https://git.k8s.io/community/contributors/design-proposals/namespaces.md#finalizers
...
- `conditions` (Block List) Represents the latest available observations of a namespace's current state. (see [below for nested schema](#nestedblock--status--conditions))
- `phase` (String) Phase is the current lifecycle phase of the namespace. More info: https://git.k8s.io/community/contributors/design-proposals/namespaces.md#phases
