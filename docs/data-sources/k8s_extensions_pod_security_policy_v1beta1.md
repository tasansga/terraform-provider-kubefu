...
- `se_linux_options` (Block List, Max: 1) seLinuxOptions required to run as; required for MustRunAs More info: https://git.k8s.io/community/contributors/design-proposals/security_context.md (see [below for nested schema](#nestedblock--spec--se_linux--se_linux_options))
