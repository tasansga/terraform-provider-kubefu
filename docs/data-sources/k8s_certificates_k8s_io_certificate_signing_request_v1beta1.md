...
- `spec` (List of Object) The certificate request itself and any additional information. (see [below for nested schema](#nestedatt--spec))
- `status` (List of Object) Derived information about the request. (see [below for nested schema](#nestedatt--status))
