...
page_title: "kubefu_flux_notification_toolkit_fluxcd_io_receiver_v1beta2 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Receiver is the Schema for the receivers API.
---

# kubefu_flux_notification_toolkit_fluxcd_io_receiver_v1beta2 (Data Source)
...
- `url` (String) URL is the generated incoming webhook address in the format of '/hook/sha256sum(token+name+namespace)'. Deprecated: Replaced by WebhookPath.
