...
page_title: "kubefu_k8s_rbac_authorization_k8s_io_role_v1alpha1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Role is a namespaced, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding.
---

# kubefu_k8s_rbac_authorization_k8s_io_role_v1alpha1 (Data Source)
...
- `rules` (Block List) Rules holds all the PolicyRules for this Role (see [below for nested schema](#nestedblock--rules))
