...
- `named_resources` (Block List, Max: 1) NamedResources describes available resources using the named resources model. (see [below for nested schema](#nestedblock--named_resources))
...
<a id="nestedblock--named_resources"></a>
### Nested Schema for `named_resources`

Required:

- `instances` (Block List, Min: 1) The list of all individual resources instances currently available. (see [below for nested schema](#nestedblock--named_resources--instances))

<a id="nestedblock--named_resources--instances"></a>
...
- `attributes` (Block List) Attributes defines the attributes of this resource instance. The name of each attribute must be unique. (see [below for nested schema](#nestedblock--named_resources--instances--attributes))

<a id="nestedblock--named_resources--instances--attributes"></a>
...
- `int` (Number) IntValue is a 64-bit integer.
- `int_slice` (Block List, Max: 1) IntSliceValue is an array of 64-bit integers. (see [below for nested schema](#nestedblock--named_resources--instances--attributes--int_slice))
- `quantity` (String) QuantityValue is a quantity.
- `string` (String) StringValue is a string.
- `string_slice` (Block List, Max: 1) StringSliceValue is an array of strings. (see [below for nested schema](#nestedblock--named_resources--instances--attributes--string_slice))
- `version` (String) VersionValue is a semantic version according to semver.org spec 2.0.0.

<a id="nestedblock--named_resources--instances--attributes--int_slice"></a>
### Nested Schema for `named_resources.instances.attributes.int_slice`

Required:

- `ints` (List of Number) Ints is the slice of 64-bit integers.


<a id="nestedblock--named_resources--instances--attributes--string_slice"></a>
### Nested Schema for `named_resources.instances.attributes.string_slice`

Required:

- `strings` (List of String) Strings is the slice of strings.
