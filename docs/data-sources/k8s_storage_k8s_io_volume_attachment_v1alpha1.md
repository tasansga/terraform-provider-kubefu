...
- `spec` (List of Object) Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system. (see [below for nested schema](#nestedatt--spec))
...
- `status` (List of Object) Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher. (see [below for nested schema](#nestedatt--status))
...
- `attacher` (String)
- `node_name` (String)
- `source` (List of Object) (see [below for nested schema](#nestedobjatt--spec--source))

<a id="nestedobjatt--spec--source"></a>
...
- `attach_error` (List of Object) (see [below for nested schema](#nestedobjatt--status--attach_error))
- `attached` (Boolean)
- `attachment_metadata` (Map of String)
- `detach_error` (List of Object) (see [below for nested schema](#nestedobjatt--status--detach_error))

<a id="nestedobjatt--status--attach_error"></a>
...
<a id="nestedobjatt--status--detach_error"></a>
