...
- `spec` (Block List, Min: 1, Max: 1) spec contains the signer (if any) and trust anchors. (see [below for nested schema](#nestedblock--spec))
...
- `trust_bundle` (String) trustBundle contains the individual X.509 trust anchors for this bundle, as PEM bundle of PEM-wrapped, DER-formatted X.509 certificates.
...
- `signer_name` (String) signerName indicates the associated signer, if any.
