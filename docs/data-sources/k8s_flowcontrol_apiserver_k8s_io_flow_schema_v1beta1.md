...
- `group` (Block List, Max: 1) (see [below for nested schema](#nestedblock--spec--rules--subjects--group))
- `service_account` (Block List, Max: 1) (see [below for nested schema](#nestedblock--spec--rules--subjects--service_account))
- `user` (Block List, Max: 1) (see [below for nested schema](#nestedblock--spec--rules--subjects--user))
