...
page_title: "kubefu_k8s_extensions_third_party_resource_v1beta1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  A ThirdPartyResource is a generic representation of a resource, it is used by add-ons and plugins to add new resource types to the API.  It consists of one or more Versions of the api.
---

# kubefu_k8s_extensions_third_party_resource_v1beta1 (Data Source)
...
- `versions` (Block List) Versions are versions for this third party object (see [below for nested schema](#nestedblock--versions))
