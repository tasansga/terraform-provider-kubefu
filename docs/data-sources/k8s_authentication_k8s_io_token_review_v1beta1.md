...
- `status` (List of Object) Status is filled in by the server and indicates whether the request can be authenticated. (see [below for nested schema](#nestedatt--status))
...
- `error` (String)
- `user` (List of Object) (see [below for nested schema](#nestedobjatt--status--user))

<a id="nestedobjatt--status--user"></a>
