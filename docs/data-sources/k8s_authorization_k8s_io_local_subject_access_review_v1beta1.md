...
page_title: "kubefu_k8s_authorization_k8s_io_local_subject_access_review_v1beta1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  LocalSubjectAccessReview checks whether or not a user or group can perform an action in a given namespace. Having a namespace scoped resource makes it much easier to grant namespace scoped policy that includes permissions checking.
---

# kubefu_k8s_authorization_k8s_io_local_subject_access_review_v1beta1 (Data Source)
...
- `group` (List of String) Groups is the groups you're testing for.
