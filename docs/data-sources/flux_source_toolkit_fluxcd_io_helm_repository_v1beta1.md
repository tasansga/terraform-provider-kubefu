...
page_title: "kubefu_flux_source_toolkit_fluxcd_io_helm_repository_v1beta1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  HelmRepository is the Schema for the helmrepositories API
---

# kubefu_flux_source_toolkit_fluxcd_io_helm_repository_v1beta1 (Data Source)
...
- `spec` (Block List, Max: 1) HelmRepositorySpec defines the reference to a Helm repository. (see [below for nested schema](#nestedblock--spec))
- `status` (Block List, Max: 1) HelmRepositoryStatus defines the observed state of the HelmRepository. (see [below for nested schema](#nestedblock--status))
...
- `url` (String) URL is the download link for the last index fetched.
