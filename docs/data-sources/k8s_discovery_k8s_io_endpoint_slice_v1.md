...
page_title: "kubefu_k8s_discovery_k8s_io_endpoint_slice_v1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  EndpointSlice represents a subset of the endpoints that implement a service. For a given service there may be multiple EndpointSlice objects, selected by labels, which must be joined to produce the full set of endpoints.
---

# kubefu_k8s_discovery_k8s_io_endpoint_slice_v1 (Data Source)
...
- `hints` (List of Object) hints contains information associated with how an endpoint should be consumed. (see [below for nested schema](#nestedatt--endpoints--hints))
...
- `for_zones` (List of Object) (see [below for nested schema](#nestedobjatt--endpoints--hints--for_zones))

<a id="nestedobjatt--endpoints--hints--for_zones"></a>
