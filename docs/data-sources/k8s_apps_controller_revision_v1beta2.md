...
page_title: "kubefu_k8s_apps_controller_revision_v1beta2 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
...
# kubefu_k8s_apps_controller_revision_v1beta2 (Data Source)
...
- `data` (Block List, Max: 1) Data is the serialized representation of the state. (see [below for nested schema](#nestedblock--data))
