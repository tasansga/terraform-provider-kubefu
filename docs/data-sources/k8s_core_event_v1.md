...
- `involved_object` (Block List, Min: 1, Max: 1) The object that this event is about. (see [below for nested schema](#nestedblock--involved_object))
- `metadata` (Block List, Min: 1, Max: 1) Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata (see [below for nested schema](#nestedblock--metadata))
...
- `related` (Block List, Max: 1) Optional secondary object for more complex actions. (see [below for nested schema](#nestedblock--related))
...
- `source` (Block List, Max: 1) The component reporting this event. Should be a short machine understandable string. (see [below for nested schema](#nestedblock--source))
...
<a id="nestedblock--involved_object"></a>
...
- `last_observed_time` (String) Time of the last occurrence observed
