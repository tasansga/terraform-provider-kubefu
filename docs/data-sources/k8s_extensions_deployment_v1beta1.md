...
page_title: "kubefu_k8s_extensions_deployment_v1beta1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Deployment enables declarative updates for Pods and ReplicaSets.
---

# kubefu_k8s_extensions_deployment_v1beta1 (Data Source)
...
- `revision_history_limit` (Number) The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified.
