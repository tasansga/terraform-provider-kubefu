...
- `spec` (Block List, Max: 1) ReceiverSpec defines the desired state of Receiver (see [below for nested schema](#nestedblock--spec))
- `status` (Block List, Max: 1) ReceiverStatus defines the observed state of Receiver (see [below for nested schema](#nestedblock--status))
...
- `secret_ref` (Block List, Max: 1) Secret reference containing the token used to validate the payload authenticity (see [below for nested schema](#nestedblock--spec--secret_ref))
...
- `url` (String) Generated webhook URL in the format of '/hook/sha256sum(token+name+namespace)'.
