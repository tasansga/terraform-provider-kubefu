...
page_title: "kubefu_cert_manager_acme_cert_manager_io_challenge_v1alpha2 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Challenge is a type to represent a Challenge request with an ACME server
---

# kubefu_cert_manager_acme_cert_manager_io_challenge_v1alpha2 (Data Source)
...
- `managed_identity` (Block List, Max: 1) managed identity configuration, can not be used at the same time as clientID, clientSecretSecretRef or tenantID (see [below for nested schema](#nestedblock--spec--solver--dns01--azuredns--managed_identity))
...
<a id="nestedblock--spec--solver--dns01--azuredns--managed_identity"></a>
### Nested Schema for `spec.solver.dns01.azuredns.managed_identity`
