...
page_title: "kubefu_k8s_authorization_k8s_io_subject_access_review_v1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  SubjectAccessReview checks whether or not a user or group can perform an action.
---

# kubefu_k8s_authorization_k8s_io_subject_access_review_v1 (Data Source)
...
- `spec` (Block List, Min: 1, Max: 1) Spec holds information about the request being evaluated (see [below for nested schema](#nestedblock--spec))
