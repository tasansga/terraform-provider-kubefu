...
page_title: "kubefu_k8s_authentication_k8s_io_token_review_v1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  TokenReview attempts to authenticate a token to a known user. Note: TokenReview requests may be cached by the webhook token authenticator plugin in the kube-apiserver.
---

# kubefu_k8s_authentication_k8s_io_token_review_v1 (Data Source)
