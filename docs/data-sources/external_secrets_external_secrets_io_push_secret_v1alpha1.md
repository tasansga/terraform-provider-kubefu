...
- `data_to` (Block List) DataTo defines bulk push rules that expand source Secret keys into provider entries. (see [below for nested schema](#nestedblock--spec--data_to))
...
<a id="nestedblock--spec--data_to"></a>
### Nested Schema for `spec.data_to`

Optional:

- `conversion_strategy` (String) Used to define a conversion Strategy for the secret keys
- `match` (Block List, Max: 1) Match pattern for selecting keys from the source Secret.
If not specified, all keys are selected. (see [below for nested schema](#nestedblock--spec--data_to--match))
...
Operations are applied sequentially. (see [below for nested schema](#nestedblock--spec--data_to--rewrite))
- `store_ref` (Block List, Max: 1) StoreRef specifies which SecretStore to push to. Required. (see [below for nested schema](#nestedblock--spec--data_to--store_ref))

<a id="nestedblock--spec--data_to--match"></a>
### Nested Schema for `spec.data_to.match`
...
<a id="nestedblock--spec--data_to--rewrite"></a>
### Nested Schema for `spec.data_to.rewrite`

Optional:

- `regexp` (Block List, Max: 1) Used to rewrite with regular expressions. (see [below for nested schema](#nestedblock--spec--data_to--rewrite--regexp))
- `transform` (Block List, Max: 1) Used to apply string transformation on the secrets. (see [below for nested schema](#nestedblock--spec--data_to--rewrite--transform))

<a id="nestedblock--spec--data_to--rewrite--regexp"></a>
### Nested Schema for `spec.data_to.rewrite.regexp`
...
<a id="nestedblock--spec--data_to--rewrite--transform"></a>
### Nested Schema for `spec.data_to.rewrite.transform`
...
<a id="nestedblock--spec--data_to--store_ref"></a>
### Nested Schema for `spec.data_to.store_ref`

Optional:

- `kind` (String) Kind of the SecretStore resource (SecretStore or ClusterSecretStore)
- `label_selector` (Block List, Max: 1) Optionally, sync to secret stores with label selector (see [below for nested schema](#nestedblock--spec--data_to--store_ref--label_selector))
- `name` (String) Optionally, sync to the SecretStore of the given name

<a id="nestedblock--spec--data_to--store_ref--label_selector"></a>
### Nested Schema for `spec.data_to.store_ref.label_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--data_to--store_ref--label_selector--match_expressions))
...
<a id="nestedblock--spec--data_to--store_ref--label_selector--match_expressions"></a>
### Nested Schema for `spec.data_to.store_ref.label_selector.match_expressions`
