...
page_title: "kubefu_k8s_admissionregistration_k8s_io_validating_admission_policy_v1beta1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  ValidatingAdmissionPolicy describes the definition of an admission validation policy that accepts or rejects an object without changing it.
---

# kubefu_k8s_admissionregistration_k8s_io_validating_admission_policy_v1beta1 (Data Source)
...
- `validations` (Block List) Validations contain CEL expressions which is used to apply the validation. Validations and AuditAnnotations may not both be empty; a minimum of one Validations or AuditAnnotations is required. (see [below for nested schema](#nestedblock--spec--validations))
...
- `expression` (String) Expression represents the expression which will be evaluated by CEL. ref: https://github.com/google/cel-spec CEL expressions have access to the contents of the API request/response, organized into CEL variables as well as some other useful variables:
