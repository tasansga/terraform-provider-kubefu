...
<a id="nestedblock--parameters_ref"></a>
...
<a id="nestedblock--suitable_nodes"></a>
### Nested Schema for `suitable_nodes`

Required:

- `node_selector_terms` (Block List, Min: 1) Required. A list of node selector terms. The terms are ORed. (see [below for nested schema](#nestedblock--suitable_nodes--node_selector_terms))

<a id="nestedblock--suitable_nodes--node_selector_terms"></a>
### Nested Schema for `suitable_nodes.node_selector_terms`

Optional:

- `match_expressions` (Block List) A list of node selector requirements by node's labels. (see [below for nested schema](#nestedblock--suitable_nodes--node_selector_terms--match_expressions))
- `match_fields` (Block List) A list of node selector requirements by node's fields. (see [below for nested schema](#nestedblock--suitable_nodes--node_selector_terms--match_fields))

<a id="nestedblock--suitable_nodes--node_selector_terms--match_expressions"></a>
...
<a id="nestedblock--suitable_nodes--node_selector_terms--match_fields"></a>
