...
page_title: "kubefu_k8s_resource_k8s_io_resource_claim_v1beta1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
...
# kubefu_k8s_resource_k8s_io_resource_claim_v1beta1 (Data Source)
...
This is an alpha field and requires enabling the DRADerivedAttributes feature gate. (see [below for nested schema](#nestedblock--spec--devices--requests--derived_attributes))
...
<a id="nestedblock--spec--devices--requests--capacity"></a>
### Nested Schema for `spec.devices.requests.capacity`
...
<a id="nestedblock--spec--devices--requests--derived_attributes"></a>
### Nested Schema for `spec.devices.requests.derived_attributes`
...
- `cel` (Block List, Max: 1) CEL contains a CEL expression for selecting a device. (see [below for nested schema](#nestedblock--spec--devices--requests--selectors--cel))

<a id="nestedblock--spec--devices--requests--selectors--cel"></a>
