...
- `deallocation_requested` (Boolean) Indicates that a claim is to be deallocated. While this is set, no new consumers may be added to ReservedFor.
...
There can be at most 32 such reservations. This may get increased in the future, but not reduced. (see [below for nested schema](#nestedblock--status--reserved_for))
