...
- `spec` (List of Object) ImagePolicySpec defines the parameters for calculating the ImagePolicy. (see [below for nested schema](#nestedatt--spec))
...
- `observed_previous_image` (String)
