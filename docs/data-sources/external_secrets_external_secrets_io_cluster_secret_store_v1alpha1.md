...
and/or user data may be supplied for the use of workload identity and user principal. (see [below for nested schema](#nestedblock--spec--provider_--oracle--auth))
