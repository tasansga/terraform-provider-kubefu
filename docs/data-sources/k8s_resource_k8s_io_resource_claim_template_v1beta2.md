...
page_title: "kubefu_k8s_resource_k8s_io_resource_claim_template_v1beta2 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
...
# kubefu_k8s_resource_k8s_io_resource_claim_template_v1beta2 (Data Source)
...
One of Exactly or FirstAvailable must be set. (see [below for nested schema](#nestedblock--spec--spec--devices--requests--exactly))
...
<a id="nestedblock--spec--spec--devices--requests--exactly"></a>
...
This is an alpha field and requires enabling the DRADerivedAttributes feature gate. (see [below for nested schema](#nestedblock--spec--spec--devices--requests--exactly--derived_attributes))
...
<a id="nestedblock--spec--spec--devices--requests--exactly--derived_attributes"></a>
### Nested Schema for `spec.spec.devices.requests.exactly.derived_attributes`
...
- `cel` (Block List, Max: 1) CEL contains a CEL expression for selecting a device. (see [below for nested schema](#nestedblock--spec--spec--devices--requests--exactly--selectors--cel))

<a id="nestedblock--spec--spec--devices--requests--exactly--selectors--cel"></a>
...
<a id="nestedblock--spec--spec--devices--requests--exactly--tolerations"></a>
