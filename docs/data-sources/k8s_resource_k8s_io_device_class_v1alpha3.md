...
- `suitable_nodes` (List of Object) (see [below for nested schema](#nestedobjatt--spec--suitable_nodes))
...
<a id="nestedobjatt--spec--suitable_nodes"></a>
### Nested Schema for `spec.suitable_nodes`

Required:

- `node_selector_terms` (List of Object) (see [below for nested schema](#nestedobjatt--spec--suitable_nodes--node_selector_terms))

<a id="nestedobjatt--spec--suitable_nodes--node_selector_terms"></a>
### Nested Schema for `spec.suitable_nodes.node_selector_terms`

Required:

- `match_expressions` (List of Object) (see [below for nested schema](#nestedobjatt--spec--suitable_nodes--node_selector_terms--match_expressions))
- `match_fields` (List of Object) (see [below for nested schema](#nestedobjatt--spec--suitable_nodes--node_selector_terms--match_fields))

<a id="nestedobjatt--spec--suitable_nodes--node_selector_terms--match_expressions"></a>
...
<a id="nestedobjatt--spec--suitable_nodes--node_selector_terms--match_fields"></a>
