...
- `spec` (Block List, Min: 1, Max: 1) Specification of the desired behavior of the Prometheus cluster. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status (see [below for nested schema](#nestedblock--spec))

### Optional

- `metadata` (Map of String)
- `status` (Block List, Max: 1) Most recent observed status of the Prometheus cluster. Read-only. Not included when requesting from the apiserver, only from the Prometheus Operator API itself. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status (see [below for nested schema](#nestedblock--status))
...
- `alerting` (Block List, Max: 1) Define details regarding alerting. (see [below for nested schema](#nestedblock--spec--alerting))
...
- `apiserver_config` (Block List, Max: 1) APIServerConfig allows specifying a host and auth methods to access apiserver. If left empty, Prometheus is assumed to run inside of the cluster and will discover API servers automatically and use the pod's CA certificate and bearer token file at /var/run/secrets/kubernetes.io/serviceaccount/. (see [below for nested schema](#nestedblock--spec--apiserver_config))
- `arbitrary_fs_access_through_s_ms` (Block List, Max: 1) ArbitraryFSAccessThroughSMs configures whether configuration based on a service monitor can access arbitrary files on the file system of the Prometheus container e.g. bearer token files. (see [below for nested schema](#nestedblock--spec--arbitrary_fs_access_through_s_ms))
- `automount_service_account_token` (Boolean) AutomountServiceAccountToken indicates whether a service account token should be automatically mounted in the pod.
...
- `convert_classic_histograms_to_nhcb` (Boolean) Whether to convert all scraped classic histograms into a native
...
- `enable_otlp_receiver` (Boolean) Enable Prometheus to be used as a receiver for the OTLP Metrics protocol.
...
- `enforced_namespace_label` (String) EnforcedNamespaceLabel If set, a label will be added to
...
- `evaluation_interval` (String) Interval between consecutive evaluations. Default: `1m`
- `excluded_from_enforcement` (Block List) List of references to PodMonitor, ServiceMonitor, Probe and PrometheusRule objects to be excluded from enforcing a namespace label of origin. Applies only if enforcedNamespaceLabel set to true. (see [below for nested schema](#nestedblock--spec--excluded_from_enforcement))
- `exemplars` (Block List, Max: 1) Exemplars related settings that are runtime reloadable. It requires to enable the exemplar storage feature to be effective. (see [below for nested schema](#nestedblock--spec--exemplars))
...
- `ignore_namespace_selectors` (Boolean) IgnoreNamespaceSelectors if set to true will ignore NamespaceSelector settings from the podmonitor and servicemonitor configs, and they will only discover endpoints within their current namespace.  Defaults to false.
...
- `image_pull_secrets` (Block List) An optional list of references to secrets in the same namespace to use for pulling prometheus and alertmanager images from registries see http://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod (see [below for nested schema](#nestedblock--spec--image_pull_secrets))
...
- `name_escaping_scheme` (String) Specifies the character escaping scheme that will be requested when scraping
...
- `otlp` (Block List, Max: 1) Settings related to the OTLP receiver feature.
It requires Prometheus >= v2.54.0. (see [below for nested schema](#nestedblock--spec--otlp))
- `override_honor_labels` (Boolean) OverrideHonorLabels if set to true overrides all user configured honor_labels. If HonorLabels is set in ServiceMonitor or PodMonitor to true, this overrides honor_labels to false.
...
- `persistent_volume_claim_retention_policy` (Block List, Max: 1) The field controls if and how PVCs are deleted during the lifecycle of a StatefulSet. The default behavior is all PVCs are retained. This is an alpha field from kubernetes 1.23 until 1.26 and a beta field from 1.26. It requires enabling the StatefulSetAutoDeletePVC feature gate. (see [below for nested schema](#nestedblock--spec--persistent_volume_claim_retention_policy))
...
- `pod_metadata` (Block List, Max: 1) PodMetadata configures Labels and Annotations which are propagated to the prometheus pods. (see [below for nested schema](#nestedblock--spec--pod_metadata))
- `pod_monitor_namespace_selector` (Block List, Max: 1) Namespace's labels to match for PodMonitor discovery. If nil, only check own namespace. (see [below for nested schema](#nestedblock--spec--pod_monitor_namespace_selector))
- `pod_monitor_selector` (Block List, Max: 1) *Experimental* PodMonitors to be selected for target discovery. *Deprecated:* if neither this nor serviceMonitorSelector are specified, configuration is unmanaged. (see [below for nested schema](#nestedblock--spec--pod_monitor_selector))
- `pod_target_labels` (List of String) PodTargetLabels are added to all Pod/ServiceMonitors' podTargetLabels
...
- `probe_namespace_selector` (Block List, Max: 1) *Experimental* Namespaces to be selected for Probe discovery. If nil, only check own namespace. (see [below for nested schema](#nestedblock--spec--probe_namespace_selector))
- `probe_selector` (Block List, Max: 1) *Experimental* Probes to be selected for target discovery. (see [below for nested schema](#nestedblock--spec--probe_selector))
...
- `query` (Block List, Max: 1) QuerySpec defines the query command line flags when starting Prometheus. (see [below for nested schema](#nestedblock--spec--query))
- `query_log_file` (String) QueryLogFile specifies the file to which PromQL queries are logged. Note that this location must be writable, and can be persisted using an attached volume. Alternatively, the location can be set to a stdout location such as `/dev/stdout` to log querie information to the default Prometheus log stream. This is only available in versions of Prometheus >= 2.16.0. For more details, see the Prometheus docs (https://prometheus.io/docs/guides/query-log/)
...
- `remote_read` (Block List) If specified, the remote_read spec. This is an experimental feature, it may change in any upcoming release in a breaking way. (see [below for nested schema](#nestedblock--spec--remote_read))
- `remote_write` (Block List) If specified, the remote_write spec. This is an experimental feature, it may change in any upcoming release in a breaking way. (see [below for nested schema](#nestedblock--spec--remote_write))
- `remote_write_receiver_message_versions` (List of String) List of the protobuf message versions to accept when receiving the
remote writes.
...
- `retention` (String) Time duration Prometheus shall retain data for. Default is '24h', and must match the regular expression `[0-9]+(ms|s|m|h|d|w|y)` (milliseconds seconds minutes hours days weeks years).
- `retention_percentage` (String) retentionPercentage defines the maximum percentage of the data volume's
...
- `retention_size` (String) Maximum amount of disk space used by blocks. Supported units: B, KB, MB, GB, TB, PB, EB. Ex: `512MB`.
...
- `rule_namespace_selector` (Block List, Max: 1) Namespaces to be selected for PrometheusRules discovery. If unspecified, only the same namespace as the Prometheus object is in is used. (see [below for nested schema](#nestedblock--spec--rule_namespace_selector))
- `rule_query_offset` (String) Defines the offset the rule evaluation timestamp of this particular group by the specified duration into the past.
It requires Prometheus >= v2.53.0.
- `rule_selector` (Block List, Max: 1) A selector to select which PrometheusRules to mount for loading alerting/recording rules from. Until (excluding) Prometheus Operator v0.24.0 Prometheus Operator will migrate any legacy rule ConfigMaps to PrometheusRule custom resources selected by RuleSelector. Make sure it does not match any config maps that you do not want to be migrated. (see [below for nested schema](#nestedblock--spec--rule_selector))
...
- `scrape_config_namespace_selector` (Block List, Max: 1) Namespace's labels to match for ScrapeConfig discovery. If nil, only check own namespace. (see [below for nested schema](#nestedblock--spec--scrape_config_namespace_selector))
- `scrape_config_selector` (Block List, Max: 1) *Experimental* ScrapeConfigs to be selected for target discovery.
 If `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector` and `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged. The Prometheus operator will ensure that the Prometheus configuration's Secret exists, but it is the responsibility of the user to provide the raw gzipped Prometheus configuration under the `prometheus.yaml.gz` key. This behavior is deprecated and will be removed in the next major version of the custom resource definition. It is recommended to use `spec.additionalScrapeConfigs` instead. (see [below for nested schema](#nestedblock--spec--scrape_config_selector))
- `scrape_failure_log_file` (String) File to which scrape failures are logged.
...
- `scrape_interval` (String) Interval between consecutive scrapes. Default: `1m`
...
- `service_discovery_role` (String) Defines the service discovery role used to discover targets from
`ServiceMonitor` objects and Alertmanager endpoints.


If set, the value should be either "Endpoints" or "EndpointSlice".
If unset, the operator assumes the "Endpoints" role.
- `service_monitor_namespace_selector` (Block List, Max: 1) Namespace's labels to match for ServiceMonitor discovery. If nil, only check own namespace. (see [below for nested schema](#nestedblock--spec--service_monitor_namespace_selector))
- `service_monitor_selector` (Block List, Max: 1) ServiceMonitors to be selected for target discovery. *Deprecated:* if neither this nor podMonitorSelector are specified, configuration is unmanaged. (see [below for nested schema](#nestedblock--spec--service_monitor_selector))
...
- `shard_retention_policy` (Block List, Max: 1) ShardRetentionPolicy defines the retention policy for the Prometheus shards.
...
* Retention duration is not settable, for now, shards are retained forever. (see [below for nested schema](#nestedblock--spec--shard_retention_policy))
...
- `thanos` (Block List, Max: 1) Thanos configuration allows configuring various aspects of a Prometheus server in a Thanos environment.
 This section is experimental, it may change significantly without deprecation notice in any release.
 This is experimental and may change significantly without backward compatibility in any release. (see [below for nested schema](#nestedblock--spec--thanos))
...
- `tracing_config` (Block List, Max: 1) EXPERIMENTAL: TracingConfig configures tracing in Prometheus. This is an experimental feature, it may change in any upcoming release in a breaking way. (see [below for nested schema](#nestedblock--spec--tracing_config))
- `tsdb` (Block List, Max: 1) Defines the runtime reloadable configuration of the timeseries database (TSDB). (see [below for nested schema](#nestedblock--spec--tsdb))
...
- `web` (Block List, Max: 1) WebSpec defines the web command line flags when starting Prometheus. (see [below for nested schema](#nestedblock--spec--web))

<a id="nestedblock--spec--additional_alert_manager_configs"></a>
...
<a id="nestedblock--spec--additional_alert_relabel_configs"></a>
...
<a id="nestedblock--spec--additional_scrape_configs"></a>
...
<a id="nestedblock--spec--alerting"></a>
### Nested Schema for `spec.alerting`

Optional:

- `alertmanagers` (Block List) AlertmanagerEndpoints Prometheus should fire alerts against. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers))

<a id="nestedblock--spec--alerting--alertmanagers"></a>
### Nested Schema for `spec.alerting.alertmanagers`

Optional:

- `alert_relabelings` (Block List) Relabeling configs applied before sending alerts to a specific Alertmanager.
It requires Prometheus >= v2.51.0. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--alert_relabelings))
- `api_version` (String) Version of the Alertmanager API that Prometheus uses to send alerts. It can be "v1" or "v2".
- `authorization` (Block List, Max: 1) Authorization section for this alertmanager endpoint (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--authorization))
- `basic_auth` (Block List, Max: 1) BasicAuth allow an endpoint to authenticate over basic authentication (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--basic_auth))
...
- `relabelings` (Block List) Relabel configuration applied to the discovered Alertmanagers. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--relabelings))
...
- `sigv4` (Block List, Max: 1) Sigv4 allows to configures AWS's Signature Verification 4 for the URL.
 ...
 Cannot be set at the same time as `basicAuth`, `bearerTokenFile` or `authorization`. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--sigv4))
- `timeout` (String) Timeout is a per-target Alertmanager timeout when pushing alerts.
- `tls_config` (Block List, Max: 1) TLS Config to use for alertmanager connection. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--tls_config))

<a id="nestedblock--spec--alerting--alertmanagers--alert_relabelings"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--authorization"></a>
### Nested Schema for `spec.alerting.alertmanagers.authorization`

Optional:

- `credentials` (Block List, Max: 1) The secret's key that contains the credentials of the request (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--authorization--credentials))
- `type` (String) Set the authentication type. Defaults to Bearer, Basic will cause an error

<a id="nestedblock--spec--alerting--alertmanagers--authorization--credentials"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--basic_auth"></a>
### Nested Schema for `spec.alerting.alertmanagers.basic_auth`

Optional:

- `password` (Block List, Max: 1) The secret in the service monitor namespace that contains the password for authentication. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--basic_auth--password))
- `username` (Block List, Max: 1) The secret in the service monitor namespace that contains the username for authentication. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--basic_auth--username))

<a id="nestedblock--spec--alerting--alertmanagers--basic_auth--password"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--basic_auth--username"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--relabelings"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--sigv4"></a>
### Nested Schema for `spec.alerting.alertmanagers.sigv4`

Optional:

- `access_key` (Block List, Max: 1) AccessKey is the AWS API key. If not specified, the environment variable `AWS_ACCESS_KEY_ID` is used. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--sigv4--access_key))
...
- `secret_key` (Block List, Max: 1) SecretKey is the AWS API secret. If not specified, the environment variable `AWS_SECRET_ACCESS_KEY` is used. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--sigv4--secret_key))
- `use_fipssts_endpoint` (Boolean) useFIPSSTSEndpoint defines FIPS mode for AWS STS endpoint.
It requires Prometheus >= v2.54.0.

<a id="nestedblock--spec--alerting--alertmanagers--sigv4--access_key"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--sigv4--secret_key"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--tls_config"></a>
### Nested Schema for `spec.alerting.alertmanagers.tls_config`

Optional:

- `ca` (Block List, Max: 1) Struct containing the CA cert to use for the targets. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--tls_config--ca))
- `ca_file` (String) Path to the CA cert in the Prometheus container to use for the targets.
- `cert` (Block List, Max: 1) Struct containing the client cert file for the targets. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--tls_config--cert))
...
- `key_secret` (Block List, Max: 1) Secret containing the client key file for the targets. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--tls_config--key_secret))
...
<a id="nestedblock--spec--alerting--alertmanagers--tls_config--ca"></a>
### Nested Schema for `spec.alerting.alertmanagers.tls_config.ca`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--tls_config--ca--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--tls_config--ca--secret))

<a id="nestedblock--spec--alerting--alertmanagers--tls_config--ca--config_map"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--tls_config--ca--secret"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--tls_config--cert"></a>
### Nested Schema for `spec.alerting.alertmanagers.tls_config.cert`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--tls_config--cert--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--alerting--alertmanagers--tls_config--cert--secret))

<a id="nestedblock--spec--alerting--alertmanagers--tls_config--cert--config_map"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--tls_config--cert--secret"></a>
...
<a id="nestedblock--spec--alerting--alertmanagers--tls_config--key_secret"></a>
...
<a id="nestedblock--spec--apiserver_config"></a>
### Nested Schema for `spec.apiserver_config`

Optional:

- `authorization` (Block List, Max: 1) Authorization section for accessing apiserver (see [below for nested schema](#nestedblock--spec--apiserver_config--authorization))
- `basic_auth` (Block List, Max: 1) BasicAuth allow an endpoint to authenticate over basic authentication (see [below for nested schema](#nestedblock--spec--apiserver_config--basic_auth))
...
It requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0.
- `proxy_url` (String) `proxyURL` defines the HTTP proxy server to use.
- `tls_config` (Block List, Max: 1) TLS Config to use for accessing apiserver. (see [below for nested schema](#nestedblock--spec--apiserver_config--tls_config))

<a id="nestedblock--spec--apiserver_config--authorization"></a>
### Nested Schema for `spec.apiserver_config.authorization`

Optional:

- `credentials` (Block List, Max: 1) The secret's key that contains the credentials of the request (see [below for nested schema](#nestedblock--spec--apiserver_config--authorization--credentials))
- `credentials_file` (String) File to read a secret from, mutually exclusive with Credentials (from SafeAuthorization)
- `type` (String) Set the authentication type. Defaults to Bearer, Basic will cause an error

<a id="nestedblock--spec--apiserver_config--authorization--credentials"></a>
...
<a id="nestedblock--spec--apiserver_config--basic_auth"></a>
### Nested Schema for `spec.apiserver_config.basic_auth`

Optional:

- `password` (Block List, Max: 1) The secret in the service monitor namespace that contains the password for authentication. (see [below for nested schema](#nestedblock--spec--apiserver_config--basic_auth--password))
- `username` (Block List, Max: 1) The secret in the service monitor namespace that contains the username for authentication. (see [below for nested schema](#nestedblock--spec--apiserver_config--basic_auth--username))

<a id="nestedblock--spec--apiserver_config--basic_auth--password"></a>
...
<a id="nestedblock--spec--apiserver_config--basic_auth--username"></a>
...
<a id="nestedblock--spec--apiserver_config--tls_config"></a>
### Nested Schema for `spec.apiserver_config.tls_config`

Optional:

- `ca` (Block List, Max: 1) Struct containing the CA cert to use for the targets. (see [below for nested schema](#nestedblock--spec--apiserver_config--tls_config--ca))
- `ca_file` (String) Path to the CA cert in the Prometheus container to use for the targets.
- `cert` (Block List, Max: 1) Struct containing the client cert file for the targets. (see [below for nested schema](#nestedblock--spec--apiserver_config--tls_config--cert))
- `cert_file` (String) Path to the client cert file in the Prometheus container for the targets.
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_file` (String) Path to the client key file in the Prometheus container for the targets.
- `key_secret` (Block List, Max: 1) Secret containing the client key file for the targets. (see [below for nested schema](#nestedblock--spec--apiserver_config--tls_config--key_secret))
- `max_version` (String) Maximum acceptable TLS version.
...
<a id="nestedblock--spec--apiserver_config--tls_config--ca"></a>
### Nested Schema for `spec.apiserver_config.tls_config.ca`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--apiserver_config--tls_config--ca--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--apiserver_config--tls_config--ca--secret))

<a id="nestedblock--spec--apiserver_config--tls_config--ca--config_map"></a>
...
<a id="nestedblock--spec--apiserver_config--tls_config--ca--secret"></a>
...
<a id="nestedblock--spec--apiserver_config--tls_config--cert"></a>
### Nested Schema for `spec.apiserver_config.tls_config.cert`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--apiserver_config--tls_config--cert--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--apiserver_config--tls_config--cert--secret))

<a id="nestedblock--spec--apiserver_config--tls_config--cert--config_map"></a>
...
<a id="nestedblock--spec--apiserver_config--tls_config--cert--secret"></a>
...
<a id="nestedblock--spec--apiserver_config--tls_config--key_secret"></a>
...
<a id="nestedblock--spec--arbitrary_fs_access_through_s_ms"></a>
...
<a id="nestedblock--spec--exemplars"></a>
...
<a id="nestedblock--spec--otlp"></a>
### Nested Schema for `spec.otlp`

Optional:

- `convert_histograms_to_nhcb` (Boolean) Configures optional translation of OTLP explicit bucket histograms into native histograms with custom buckets.
It requires Prometheus >= v3.4.0.
- `ignore_resource_attributes` (List of String) List of OpenTelemetry resource attributes to ignore when `promoteAllResourceAttributes` is true.

It requires `promoteAllResourceAttributes` to be true.
It requires Prometheus >= v3.5.0.
- `keep_identifying_resource_attributes` (Boolean) Enables adding `service.name`, `service.namespace` and `service.instance.id`
...
- `promote_scope_metadata` (Boolean) promoteScopeMetadata controls whether to promote OpenTelemetry scope metadata (i.e. name, version, schema URL, and attributes) to metric labels.
...
- `translation_strategy` (String) Configures how the OTLP receiver endpoint translates the incoming metrics.
If unset, Prometheus uses its default value.
...
<a id="nestedblock--spec--pod_monitor_namespace_selector"></a>
### Nested Schema for `spec.pod_monitor_namespace_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--pod_monitor_namespace_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--pod_monitor_namespace_selector--match_expressions"></a>
...
<a id="nestedblock--spec--pod_monitor_selector"></a>
### Nested Schema for `spec.pod_monitor_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--pod_monitor_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--pod_monitor_selector--match_expressions"></a>
...
<a id="nestedblock--spec--probe_namespace_selector"></a>
### Nested Schema for `spec.probe_namespace_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--probe_namespace_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--probe_namespace_selector--match_expressions"></a>
...
<a id="nestedblock--spec--probe_selector"></a>
### Nested Schema for `spec.probe_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--probe_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--probe_selector--match_expressions"></a>
...
<a id="nestedblock--spec--remote_read"></a>
### Nested Schema for `spec.remote_read`

Optional:

- `authorization` (Block List, Max: 1) Authorization section for remote read (see [below for nested schema](#nestedblock--spec--remote_read--authorization))
- `basic_auth` (Block List, Max: 1) BasicAuth for the URL. (see [below for nested schema](#nestedblock--spec--remote_read--basic_auth))
- `bearer_token` (String) Bearer token for remote read.
- `bearer_token_file` (String) File to read bearer token for remote read.
- `filter_external_labels` (Boolean) Whether to use the external labels as selectors for the remote read endpoint. Requires Prometheus v2.34.0 and above.
...
- `name` (String) The name of the remote read queue, must be unique if specified. The name is used in metrics and logging in order to differentiate read configurations.  Only valid in Prometheus versions 2.15.0 and newer.
- `no_proxy` (String) `noProxy` is a comma-separated string that can contain IPs, CIDR notation, domain names
that should be excluded from proxying. IP and domain names can
contain port numbers.
...
- `oauth2` (Block List, Max: 1) OAuth2 for the URL. Only valid in Prometheus versions 2.27.0 and newer. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2))
- `proxy_connect_header` (Map of String) ProxyConnectHeader optionally specifies headers to send to
proxies during CONNECT requests.
...
- `tls_config` (Block List, Max: 1) TLS Config to use for remote read. (see [below for nested schema](#nestedblock--spec--remote_read--tls_config))
- `url` (String) The URL of the endpoint to send samples to.

<a id="nestedblock--spec--remote_read--authorization"></a>
### Nested Schema for `spec.remote_read.authorization`

Optional:

- `credentials` (Block List, Max: 1) The secret's key that contains the credentials of the request (see [below for nested schema](#nestedblock--spec--remote_read--authorization--credentials))
- `credentials_file` (String) File to read a secret from, mutually exclusive with Credentials (from SafeAuthorization)
- `type` (String) Set the authentication type. Defaults to Bearer, Basic will cause an error

<a id="nestedblock--spec--remote_read--authorization--credentials"></a>
...
<a id="nestedblock--spec--remote_read--basic_auth"></a>
### Nested Schema for `spec.remote_read.basic_auth`

Optional:

- `password` (Block List, Max: 1) The secret in the service monitor namespace that contains the password for authentication. (see [below for nested schema](#nestedblock--spec--remote_read--basic_auth--password))
- `username` (Block List, Max: 1) The secret in the service monitor namespace that contains the username for authentication. (see [below for nested schema](#nestedblock--spec--remote_read--basic_auth--username))

<a id="nestedblock--spec--remote_read--basic_auth--password"></a>
...
<a id="nestedblock--spec--remote_read--basic_auth--username"></a>
...
<a id="nestedblock--spec--remote_read--oauth2"></a>
### Nested Schema for `spec.remote_read.oauth2`

Optional:

- `client_id` (Block List, Max: 1) The secret or configmap containing the OAuth2 client id (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--client_id))
- `client_secret` (Block List, Max: 1) The secret containing the OAuth2 client secret (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--client_secret))
...
It requires Prometheus >= v2.43.0. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--tls_config))
- `token_url` (String) The URL to fetch the token from

<a id="nestedblock--spec--remote_read--oauth2--client_id"></a>
### Nested Schema for `spec.remote_read.oauth2.client_id`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--client_id--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--client_id--secret))

<a id="nestedblock--spec--remote_read--oauth2--client_id--config_map"></a>
...
<a id="nestedblock--spec--remote_read--oauth2--client_id--secret"></a>
...
<a id="nestedblock--spec--remote_read--oauth2--client_secret"></a>
...
<a id="nestedblock--spec--remote_read--oauth2--tls_config"></a>
### Nested Schema for `spec.remote_read.oauth2.tls_config`

Optional:

- `ca` (Block List, Max: 1) Certificate authority used when verifying server certificates. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--tls_config--ca))
- `cert` (Block List, Max: 1) Client certificate to present when doing client-authentication. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--tls_config--cert))
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_secret` (Block List, Max: 1) Secret containing the client key file for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--tls_config--key_secret))
- `max_version` (String) Maximum acceptable TLS version.
...
<a id="nestedblock--spec--remote_read--oauth2--tls_config--ca"></a>
### Nested Schema for `spec.remote_read.oauth2.tls_config.ca`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--tls_config--ca--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--tls_config--ca--secret))

<a id="nestedblock--spec--remote_read--oauth2--tls_config--ca--config_map"></a>
...
<a id="nestedblock--spec--remote_read--oauth2--tls_config--ca--secret"></a>
...
<a id="nestedblock--spec--remote_read--oauth2--tls_config--cert"></a>
### Nested Schema for `spec.remote_read.oauth2.tls_config.cert`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--tls_config--cert--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--oauth2--tls_config--cert--secret))

<a id="nestedblock--spec--remote_read--oauth2--tls_config--cert--config_map"></a>
...
<a id="nestedblock--spec--remote_read--oauth2--tls_config--cert--secret"></a>
...
<a id="nestedblock--spec--remote_read--oauth2--tls_config--key_secret"></a>
...
<a id="nestedblock--spec--remote_read--tls_config"></a>
### Nested Schema for `spec.remote_read.tls_config`

Optional:

- `ca` (Block List, Max: 1) Struct containing the CA cert to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--tls_config--ca))
- `ca_file` (String) Path to the CA cert in the Prometheus container to use for the targets.
- `cert` (Block List, Max: 1) Struct containing the client cert file for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--tls_config--cert))
- `cert_file` (String) Path to the client cert file in the Prometheus container for the targets.
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_file` (String) Path to the client key file in the Prometheus container for the targets.
- `key_secret` (Block List, Max: 1) Secret containing the client key file for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--tls_config--key_secret))
- `max_version` (String) Maximum acceptable TLS version.
...
<a id="nestedblock--spec--remote_read--tls_config--ca"></a>
### Nested Schema for `spec.remote_read.tls_config.ca`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--tls_config--ca--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--tls_config--ca--secret))

<a id="nestedblock--spec--remote_read--tls_config--ca--config_map"></a>
...
<a id="nestedblock--spec--remote_read--tls_config--ca--secret"></a>
...
<a id="nestedblock--spec--remote_read--tls_config--cert"></a>
### Nested Schema for `spec.remote_read.tls_config.cert`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--tls_config--cert--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_read--tls_config--cert--secret))

<a id="nestedblock--spec--remote_read--tls_config--cert--config_map"></a>
...
<a id="nestedblock--spec--remote_read--tls_config--cert--secret"></a>
...
<a id="nestedblock--spec--remote_read--tls_config--key_secret"></a>
...
- `authorization` (Block List, Max: 1) Authorization section for remote write (see [below for nested schema](#nestedblock--spec--remote_write--authorization))
...
- `basic_auth` (Block List, Max: 1) BasicAuth for the URL. (see [below for nested schema](#nestedblock--spec--remote_write--basic_auth))
...
It requires Prometheus >= v2.54.0.
- `metadata_config` (Block List, Max: 1) MetadataConfig configures the sending of series metadata to remote storage. (see [below for nested schema](#nestedblock--spec--remote_write--metadata_config))
- `name` (String) The name of the remote write queue, must be unique if specified. The name is used in metrics and logging in order to differentiate queues. Only valid in Prometheus versions 2.15.0 and newer.
- `no_proxy` (String) `noProxy` is a comma-separated string that can contain IPs, CIDR notation, domain names
that should be excluded from proxying. IP and domain names can
contain port numbers.
...
It requires Prometheus >= v2.43.0.
- `oauth2` (Block List, Max: 1) OAuth2 for the URL. Only valid in Prometheus versions 2.27.0 and newer. (see [below for nested schema](#nestedblock--spec--remote_write--oauth2))
- `proxy_connect_header` (Map of String) ProxyConnectHeader optionally specifies headers to send to
proxies during CONNECT requests.
...
- `send_native_histograms` (Boolean) Enables sending of native histograms, also known as sparse histograms over remote write.
 It requires Prometheus >= v2.40.0.
- `sigv4` (Block List, Max: 1) Sigv4 allows to configures AWS's Signature Verification 4 (see [below for nested schema](#nestedblock--spec--remote_write--sigv4))
- `tls_config` (Block List, Max: 1) TLS Config to use for remote write. (see [below for nested schema](#nestedblock--spec--remote_write--tls_config))
- `url` (String) The URL of the endpoint to send samples to.
...
- `credentials` (Block List, Max: 1) The secret's key that contains the credentials of the request (see [below for nested schema](#nestedblock--spec--remote_write--authorization--credentials))
- `credentials_file` (String) File to read a secret from, mutually exclusive with Credentials (from SafeAuthorization)
- `type` (String) Set the authentication type. Defaults to Bearer, Basic will cause an error
...
- `managed_identity` (Block List, Max: 1) ManagedIdentity defines the Azure User-assigned Managed identity. (see [below for nested schema](#nestedblock--spec--remote_write--azure_ad--managed_identity))
- `oauth` (Block List, Max: 1) OAuth defines the oauth config that is being used to authenticate. Cannot be set at the same time as `managedIdentity`.
 It requires Prometheus >= v2.48.0. (see [below for nested schema](#nestedblock--spec--remote_write--azure_ad--oauth))
...
It requires Prometheus >= 2.52.0. (see [below for nested schema](#nestedblock--spec--remote_write--azure_ad--sdk))
...
- `password` (Block List, Max: 1) The secret in the service monitor namespace that contains the password for authentication. (see [below for nested schema](#nestedblock--spec--remote_write--basic_auth--password))
- `username` (Block List, Max: 1) The secret in the service monitor namespace that contains the username for authentication. (see [below for nested schema](#nestedblock--spec--remote_write--basic_auth--username))
...
- `send` (Boolean) Whether metric metadata is sent to remote storage or not.
- `send_interval` (String) How frequently metric metadata is sent to remote storage.
...
- `client_id` (Block List, Max: 1) The secret or configmap containing the OAuth2 client id (see [below for nested schema](#nestedblock--spec--remote_write--oauth2--client_id))
- `client_secret` (Block List, Max: 1) The secret containing the OAuth2 client secret (see [below for nested schema](#nestedblock--spec--remote_write--oauth2--client_secret))
- `endpoint_params` (Map of String) Parameters to append to the token URL
- `no_proxy` (String) `noProxy` is a comma-separated string that can contain IPs, CIDR notation, domain names
that should be excluded from proxying. IP and domain names can
contain port numbers.
...
- `region` (String) Region is the AWS region. If blank, the region from the default credentials chain used.
- `role_arn` (String) RoleArn is the named AWS profile used to authenticate.
- `secret_key` (Block List, Max: 1) SecretKey is the AWS API secret. If blank, the environment variable `AWS_SECRET_ACCESS_KEY` is used. (see [below for nested schema](#nestedblock--spec--remote_write--sigv4--secret_key))
- `use_fipssts_endpoint` (Boolean) useFIPSSTSEndpoint defines FIPS mode for AWS STS endpoint.
It requires Prometheus >= v2.54.0.
...
- `ca` (Block List, Max: 1) Struct containing the CA cert to use for the targets. (see [below for nested schema](#nestedblock--spec--remote_write--tls_config--ca))
- `ca_file` (String) Path to the CA cert in the Prometheus container to use for the targets.
- `cert` (Block List, Max: 1) Struct containing the client cert file for the targets. (see [below for nested schema](#nestedblock--spec--remote_write--tls_config--cert))
- `cert_file` (String) Path to the client cert file in the Prometheus container for the targets.
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_file` (String) Path to the client key file in the Prometheus container for the targets.
...
- `alert` (Block List, Max: 1) /--rules.alert.*/ command-line arguments (see [below for nested schema](#nestedblock--spec--rules--alert))

<a id="nestedblock--spec--rules--alert"></a>
...
<a id="nestedblock--spec--runtime"></a>
### Nested Schema for `spec.runtime`

Optional:

- `go_gc` (Number) The Go garbage collection target percentage. Lowering this number may increase the CPU usage.
See: https://tip.golang.org/doc/gc-guide#GOGC


<a id="nestedblock--spec--scrape_classes"></a>
### Nested Schema for `spec.scrape_classes`

Optional:

- `attach_metadata` (Block List, Max: 1) AttachMetadata configures additional metadata to the discovered targets.
When the scrape object defines its own configuration, it takes
precedence over the scrape class configuration. (see [below for nested schema](#nestedblock--spec--scrape_classes--attach_metadata))
- `authorization` (Block List, Max: 1) Authorization section for the ScrapeClass.
It will only apply if the scrape resource doesn't specify any Authorization. (see [below for nested schema](#nestedblock--spec--scrape_classes--authorization))
- `default` (Boolean) Default indicates that the scrape applies to all scrape objects that don't configure an explicit scrape class name.
...
It requires Prometheus >= v3.0.0.
- `metric_relabelings` (Block List) MetricRelabelings configures the relabeling rules to apply to all samples before ingestion.
...
More info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#metric_relabel_configs (see [below for nested schema](#nestedblock--spec--scrape_classes--metric_relabelings))
- `name` (String) Name of the scrape class.
- `relabelings` (Block List) Relabelings configures the relabeling rules to apply to all scrape targets.
 ...
 More info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config (see [below for nested schema](#nestedblock--spec--scrape_classes--relabelings))
- `tls_config` (Block List, Max: 1) TLSConfig section for scrapes. (see [below for nested schema](#nestedblock--spec--scrape_classes--tls_config))

<a id="nestedblock--spec--scrape_classes--attach_metadata"></a>
### Nested Schema for `spec.scrape_classes.attach_metadata`

Optional:

- `node` (Boolean) When set to true, Prometheus attaches node metadata to the discovered
targets.
...
<a id="nestedblock--spec--scrape_classes--authorization"></a>
### Nested Schema for `spec.scrape_classes.authorization`

Optional:

- `credentials` (Block List, Max: 1) Selects a key of a Secret in the namespace that contains the credentials for authentication. (see [below for nested schema](#nestedblock--spec--scrape_classes--authorization--credentials))
...
<a id="nestedblock--spec--scrape_classes--authorization--credentials"></a>
### Nested Schema for `spec.scrape_classes.authorization.credentials`
...
<a id="nestedblock--spec--scrape_classes--metric_relabelings"></a>
...
<a id="nestedblock--spec--scrape_classes--relabelings"></a>
...
<a id="nestedblock--spec--scrape_classes--tls_config"></a>
### Nested Schema for `spec.scrape_classes.tls_config`

Optional:

- `ca` (Block List, Max: 1) Certificate authority used when verifying server certificates. (see [below for nested schema](#nestedblock--spec--scrape_classes--tls_config--ca))
- `ca_file` (String) Path to the CA cert in the Prometheus container to use for the targets.
- `cert` (Block List, Max: 1) Client certificate to present when doing client-authentication. (see [below for nested schema](#nestedblock--spec--scrape_classes--tls_config--cert))
- `cert_file` (String) Path to the client cert file in the Prometheus container for the targets.
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_file` (String) Path to the client key file in the Prometheus container for the targets.
- `key_secret` (Block List, Max: 1) Secret containing the client key file for the targets. (see [below for nested schema](#nestedblock--spec--scrape_classes--tls_config--key_secret))
- `max_version` (String) Maximum acceptable TLS version.
...
<a id="nestedblock--spec--scrape_classes--tls_config--ca"></a>
### Nested Schema for `spec.scrape_classes.tls_config.ca`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--scrape_classes--tls_config--ca--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--scrape_classes--tls_config--ca--secret))

<a id="nestedblock--spec--scrape_classes--tls_config--ca--config_map"></a>
...
<a id="nestedblock--spec--scrape_classes--tls_config--ca--secret"></a>
...
<a id="nestedblock--spec--scrape_classes--tls_config--cert"></a>
### Nested Schema for `spec.scrape_classes.tls_config.cert`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--scrape_classes--tls_config--cert--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--scrape_classes--tls_config--cert--secret))

<a id="nestedblock--spec--scrape_classes--tls_config--cert--config_map"></a>
...
<a id="nestedblock--spec--scrape_classes--tls_config--cert--secret"></a>
...
<a id="nestedblock--spec--scrape_classes--tls_config--key_secret"></a>
...
<a id="nestedblock--spec--scrape_config_namespace_selector"></a>
### Nested Schema for `spec.scrape_config_namespace_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--scrape_config_namespace_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--scrape_config_namespace_selector--match_expressions"></a>
...
<a id="nestedblock--spec--scrape_config_selector"></a>
### Nested Schema for `spec.scrape_config_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--scrape_config_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--scrape_config_selector--match_expressions"></a>
...
<a id="nestedblock--spec--service_monitor_namespace_selector"></a>
### Nested Schema for `spec.service_monitor_namespace_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--service_monitor_namespace_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--service_monitor_namespace_selector--match_expressions"></a>
...
<a id="nestedblock--spec--service_monitor_selector"></a>
### Nested Schema for `spec.service_monitor_selector`

Optional:

- `match_expressions` (Block List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedblock--spec--service_monitor_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.

<a id="nestedblock--spec--service_monitor_selector--match_expressions"></a>
...
<a id="nestedblock--spec--shard_retention_policy"></a>
### Nested Schema for `spec.shard_retention_policy`

Optional:

- `retain` (Block List, Max: 1) Defines the config for retention when the retention policy is set to `Retain`.
This field is ineffective as of now. (see [below for nested schema](#nestedblock--spec--shard_retention_policy--retain))
- `when_scaled` (String) Defines the retention policy when the Prometheus shards are scaled down.
...
<a id="nestedblock--spec--shard_retention_policy--retain"></a>
### Nested Schema for `spec.shard_retention_policy.retain`

Optional:

- `retention_period` (String) Duration is a valid time duration that can be parsed by Prometheus model.ParseDuration() function.
...
- `object_storage_config` (Block List, Max: 1) ObjectStorageConfig configures object storage in Thanos. Alternative to ObjectStorageConfigFile, and lower order priority. (see [below for nested schema](#nestedblock--spec--thanos--object_storage_config))
...
- `resources` (Block List, Max: 1) Resources defines the resource requirements for the Thanos sidecar. If not provided, no requests/limits will be set (see [below for nested schema](#nestedblock--spec--thanos--resources))
...
- `tracing_config` (Block List, Max: 1) TracingConfig configures tracing in Thanos. This is an experimental feature, it may change in any upcoming release in a breaking way. (see [below for nested schema](#nestedblock--spec--thanos--tracing_config))
...
- `volume_mounts` (Block List) VolumeMounts allows configuration of additional VolumeMounts on the output StatefulSet definition. VolumeMounts specified will be appended to other VolumeMounts in the thanos-sidecar container. (see [below for nested schema](#nestedblock--spec--thanos--volume_mounts))

<a id="nestedblock--spec--thanos--additional_args"></a>
...
<a id="nestedblock--spec--thanos--grpc_server_tls_config"></a>
### Nested Schema for `spec.thanos.grpc_server_tls_config`

Optional:

- `ca` (Block List, Max: 1) Struct containing the CA cert to use for the targets. (see [below for nested schema](#nestedblock--spec--thanos--grpc_server_tls_config--ca))
- `ca_file` (String) Path to the CA cert in the Prometheus container to use for the targets.
- `cert` (Block List, Max: 1) Struct containing the client cert file for the targets. (see [below for nested schema](#nestedblock--spec--thanos--grpc_server_tls_config--cert))
- `cert_file` (String) Path to the client cert file in the Prometheus container for the targets.
...
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_file` (String) Path to the client key file in the Prometheus container for the targets.
- `key_secret` (Block List, Max: 1) Secret containing the client key file for the targets. (see [below for nested schema](#nestedblock--spec--thanos--grpc_server_tls_config--key_secret))
- `max_version` (String) Maximum acceptable TLS version.
...
<a id="nestedblock--spec--thanos--grpc_server_tls_config--ca"></a>
### Nested Schema for `spec.thanos.grpc_server_tls_config.ca`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--thanos--grpc_server_tls_config--ca--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--thanos--grpc_server_tls_config--ca--secret))

<a id="nestedblock--spec--thanos--grpc_server_tls_config--ca--config_map"></a>
...
<a id="nestedblock--spec--thanos--grpc_server_tls_config--ca--secret"></a>
...
<a id="nestedblock--spec--thanos--grpc_server_tls_config--cert"></a>
### Nested Schema for `spec.thanos.grpc_server_tls_config.cert`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--thanos--grpc_server_tls_config--cert--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--thanos--grpc_server_tls_config--cert--secret))

<a id="nestedblock--spec--thanos--grpc_server_tls_config--cert--config_map"></a>
...
<a id="nestedblock--spec--thanos--grpc_server_tls_config--cert--secret"></a>
...
<a id="nestedblock--spec--thanos--grpc_server_tls_config--key_secret"></a>
...
<a id="nestedblock--spec--thanos--object_storage_config"></a>
...
<a id="nestedblock--spec--thanos--resources"></a>
...
- `claims` (Block List) Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.
 This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.
 This field is immutable. (see [below for nested schema](#nestedblock--spec--thanos--resources--claims))
- `limits` (Map of String) Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
- `requests` (Map of String) Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/

<a id="nestedblock--spec--thanos--resources--claims"></a>
...
<a id="nestedblock--spec--thanos--tracing_config"></a>
...
<a id="nestedblock--spec--thanos--volume_mounts"></a>
...
- `tls_config` (Block List, Max: 1) TLS Config to use when sending traces. (see [below for nested schema](#nestedblock--spec--tracing_config--tls_config))

<a id="nestedblock--spec--tracing_config--tls_config"></a>
### Nested Schema for `spec.tracing_config.tls_config`

Optional:

- `ca` (Block List, Max: 1) Certificate authority used when verifying server certificates. (see [below for nested schema](#nestedblock--spec--tracing_config--tls_config--ca))
- `ca_file` (String) Path to the CA cert in the Prometheus container to use for the targets.
- `cert` (Block List, Max: 1) Client certificate to present when doing client-authentication. (see [below for nested schema](#nestedblock--spec--tracing_config--tls_config--cert))
- `cert_file` (String) Path to the client cert file in the Prometheus container for the targets.
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_file` (String) Path to the client key file in the Prometheus container for the targets.
- `key_secret` (Block List, Max: 1) Secret containing the client key file for the targets. (see [below for nested schema](#nestedblock--spec--tracing_config--tls_config--key_secret))
- `max_version` (String) Maximum acceptable TLS version.
...
<a id="nestedblock--spec--tracing_config--tls_config--ca"></a>
### Nested Schema for `spec.tracing_config.tls_config.ca`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--tracing_config--tls_config--ca--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--tracing_config--tls_config--ca--secret))

<a id="nestedblock--spec--tracing_config--tls_config--ca--config_map"></a>
...
<a id="nestedblock--spec--tracing_config--tls_config--ca--secret"></a>
...
<a id="nestedblock--spec--tracing_config--tls_config--cert"></a>
### Nested Schema for `spec.tracing_config.tls_config.cert`

Optional:

- `config_map` (Block List, Max: 1) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--tracing_config--tls_config--cert--config_map))
- `secret` (Block List, Max: 1) Secret containing data to use for the targets. (see [below for nested schema](#nestedblock--spec--tracing_config--tls_config--cert--secret))

<a id="nestedblock--spec--tracing_config--tls_config--cert--config_map"></a>
...
<a id="nestedblock--spec--tracing_config--tls_config--cert--secret"></a>
...
<a id="nestedblock--spec--tracing_config--tls_config--key_secret"></a>
...
- `tls_config` (Block List, Max: 1) WebTLSConfig defines the TLS parameters for HTTPS. (see [below for nested schema](#nestedblock--spec--web--tls_config))
...
- `available_replicas` (Number) Total number of available pods (ready for at least minReadySeconds) targeted by this Prometheus deployment.
- `conditions` (Block List) The current state of the Prometheus deployment. (see [below for nested schema](#nestedblock--status--conditions))
...
- `replicas` (Number) Total number of non-terminated pods targeted by this Prometheus deployment (their labels match the selector).
- `selector` (String) The selector used to match the pods targeted by this Prometheus resource.
- `shard_statuses` (Block List) The list has one entry per shard. Each entry provides a summary of the shard status. (see [below for nested schema](#nestedblock--status--shard_statuses))
- `shards` (Number) Shards is the most recently observed number of shards.
- `unavailable_replicas` (Number) Total number of unavailable pods targeted by this Prometheus deployment.
- `updated_replicas` (Number) Total number of non-terminated pods targeted by this Prometheus deployment that have the desired version spec.
...
<a id="nestedblock--status--shard_statuses"></a>
### Nested Schema for `status.shard_statuses`

Optional:

- `available_replicas` (Number) Total number of available pods (ready for at least minReadySeconds) targeted by this shard.
- `replicas` (Number) Total number of pods targeted by this shard.
- `shard_id` (String) Identifier of the shard.
- `unavailable_replicas` (Number) Total number of unavailable pods targeted by this shard.
- `updated_replicas` (Number) Total number of non-terminated pods targeted by this shard that have the desired spec.
