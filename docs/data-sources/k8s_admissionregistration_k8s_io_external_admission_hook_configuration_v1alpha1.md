...
- `client_config` (Block List, Min: 1, Max: 1) ClientConfig defines how to communicate with the hook. Required (see [below for nested schema](#nestedblock--external_admission_hooks--client_config))
...
<a id="nestedblock--external_admission_hooks--client_config"></a>
...
- `service` (Block List, Min: 1, Max: 1) Service is a reference to the service for this webhook. If there is only one port open for the service, that port will be used. If there are multiple ports open, port 443 will be used if it is open, otherwise it is an error. Required (see [below for nested schema](#nestedblock--external_admission_hooks--client_config--service))

<a id="nestedblock--external_admission_hooks--client_config--service"></a>
