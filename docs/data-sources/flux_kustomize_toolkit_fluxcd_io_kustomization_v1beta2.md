...
page_title: "kubefu_flux_kustomize_toolkit_fluxcd_io_kustomization_v1beta2 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Kustomization is the Schema for the kustomizations API.
---

# kubefu_flux_kustomize_toolkit_fluxcd_io_kustomization_v1beta2 (Data Source)
...
- `patches_json6902` (Block List) JSON 6902 patches, defined as inline YAML objects. Deprecated: Use Patches instead. (see [below for nested schema](#nestedblock--spec--patches_json6902))
- `patches_strategic_merge` (List of Map of String) Strategic merge patches, defined as inline YAML objects. Deprecated: Use Patches instead.
