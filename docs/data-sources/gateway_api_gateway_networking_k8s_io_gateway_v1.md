...
page_title: "kubefu_gateway_api_gateway_networking_k8s_io_gateway_v1 Data Source - terraform-provider-kubefu"
subcategory: ""
description: |-
  Gateway represents an instance of a service-traffic handling infrastructure by binding Listeners to a set of IP addresses.
---

# kubefu_gateway_api_gateway_networking_k8s_io_gateway_v1 (Data Source)
...
- `from` (String) From indicates where Routes will be selected for this Gateway. Possible values are:
...
- `name` (String) Name is the name of the referent.
- `namespace` (String) Namespace is the namespace of the referenced object. When unspecified, the local namespace is inferred.
 ...
 * "Accepted" * "Programmed" * "Ready" (see [below for nested schema](#nestedblock--status--conditions))
